# %%
import pandas as pd
file = r'C:\Users\moham\OneDrive\Desktop\WebScraping\legacy_app\nillens.csv'
df = pd.read_csv(file)
...
df_merged.to_csv(r'C:\Users\moham\OneDrive\Desktop\WebScraping\legacy_app\nillens_compact_view.csv', index=False)
df_merged
...
df_products.to_csv(r'C:\Users\moham\OneDrive\Desktop\WebScraping\legacy_app\nillens_products.csv', index=False)
df_products
...
df_variants.to_csv(r'C:\Users\moham\OneDrive\Desktop\WebScraping\legacy_app\nillens_variants.csv', index=False)
df_variants
